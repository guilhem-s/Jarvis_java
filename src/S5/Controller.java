...
public class Controller
{
    ...
    public EV3MediumRegulatedMotor pinces;
    
    public Controller(Port left_port,Port right_port, Port center_port) {
    	drive = new DifferentialDrive(left_port,right_port);
    	pinces = new EV3MediumRegulatedMotor(center_port);
    }
    ...
    public void skip_forward(int duration)
    {
        drive.forward();
    ...
    public boolean sweepClockwise(int rot_limit)
    {
    ...
    public boolean sweepCounterClockwise(int rot_limit)
    {
    ...
    private boolean sweep(int rot_limit)
    {
        ...
        public void sweep2(int rot_limit)
        {
            for (int i = 0; i < (rot_limit * DELAYS_PER_DEG); i++)
            {
                delay();
